  ...
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="2026-05-25">
      ...
      <ul>
        ...
        <li><strong>Our hosting provider</strong> — platform we run the backend on. To be named here when production hosting is finalised; expected to be a major EU / US cloud provider with a published data-processing addendum.</li>
      </ul>
